...
export default function OrdersPage() {
  ...
  const handleReorder = (order: Order) => {
    // Navigate to cake page or add to cart
    router.push(`/cakes/${order.id}`);
  };
  ...
  const filteredOrders = orders.filter(order => {
    const matchesSearch = order.cakeName.toLowerCase().includes(searchQuery.toLowerCase()) ||
            ...
            <div className="lg:w-2/3">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-4 border-2 border-purple-200">
                  ...
                  <p className="text-2xl font-bold text-purple-600">{currencySymbol}{stats.totalSpent}</p>
                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4">
                          <div>
                            <h3 className="text-2xl font-bold mb-2">{order.cakeName}</h3>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                          <div className="bg-gray-50 rounded-lg p-3">
                            ...
                            <p className="font-bold text-lg">{order.quantity} kg</p>
                          </div>
                          <div className="bg-gray-50 rounded-lg p-3">
                            <p className="text-xs text-gray-500 mb-1">Total</p>
                            <p className="font-bold text-lg text-pink-600">{currencySymbol}{order.totalPrice}</p>
                          </div>
                          <div className="bg-gray-50 rounded-lg p-3">
                        ...
                        <div className="flex flex-wrap gap-3">
                          ...
                          <a
                            href={`https://wa.me/${settings.whatsapp.replace(/[^0-9]/g, '')}?text=Hi, I have a question about my order %23${order.id.slice(0, 8)}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-4 py-2 border-2 border-green-300 text-green-600 rounded-lg hover:bg-green-50 transition font-semibold"
                          >
