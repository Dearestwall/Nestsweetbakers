import { RefreshCw, CheckCircle, XCircle, Clock, CreditCard, AlertTriangle } from 'lucide-react';
          ...
          <div className="prose prose-pink max-w-none space-y-8">
            <section>
              ...
              <div className="bg-red-50 border-2 border-red-200 p-6 rounded-xl">
                <h3 className="font-bold text-lg mb-3 text-red-800">Non-Cancellable Orders</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                  <li>Orders in &quot;Out for Delivery&quot; status</li>
                  <li>Orders after preparation has started</li>
                  <li>Special occasion orders within 6 hours of delivery time</li>
              ...
              <div className="bg-gradient-to-r from-pink-100 to-purple-100 p-6 rounded-xl mb-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-pink-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold">1</div>
                    <div>
                      <p className="font-semibold">Cancellation Requested</p>
                      <p className="text-gray-700 text-sm">Immediately processed in our system</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-pink-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold">2</div>
                    <div>
                      <p className="font-semibold">Refund Initiated</p>
                      <p className="text-gray-700 text-sm">Within 24 hours of cancellation approval</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-pink-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold">3</div>
                    <div>
                      <p className="font-semibold">Amount Credited</p>
                      <p className="text-gray-700 text-sm">5-7 business days (depends on your bank)</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-white border-2 border-pink-200 p-6 rounded-xl">
                  <h3 className="font-bold text-lg mb-3 text-pink-800">Full Refund (100%)</h3>
                  <ul className="list-disc list-inside space-y-2 text-gray-700">
                    <li>Order not delivered by promised time (delay {'>'} 1 hour)</li>
                ...
                <div className="bg-white border-2 border-orange-200 p-6 rounded-xl">
                  <h3 className="font-bold text-lg mb-3 text-orange-800">Partial Refund (50%)</h3>
                  <ul className="list-disc list-inside space-y-2 text-gray-700">
                    <li>Cancellation 12-24 hours before delivery (custom orders)</li>
                    <li>Minor product defects reported within 2 hours</li>
                    <li>Partially missing items (refund for missing portion only)</li>
                  </ul>
                </div>

                <div className="bg-white border-2 border-red-200 p-6 rounded-xl">
                  <h3 className="font-bold text-lg mb-3 text-red-800">No Refund</h3>
                  <ul className="list-disc list-inside space-y-2 text-gray-700">
                    <li>Change of mind after order preparation</li>
                    <li>Incorrect address provided by customer</li>
                    <li>Customer not available for delivery (after 3 attempts)</li>
            ...
            <section>
              ...
              <div className="bg-pink-50 p-6 rounded-xl space-y-4">
                <p className="text-gray-700 font-semibold">To request a refund or report an issue:</p>
                <ol className="list-decimal list-inside space-y-3 text-gray-700">
                  <li>
                    <strong>Via Website:</strong> Go to &quot;My Orders&quot; → Select order → Click &quot;Request Refund&quot;
                  </li>
                  <li>
                    <strong>Via Email:</strong> Send details to refunds@nestsweets.com with order number and photos (if applicable)
                  </li>
                  <li>
                    <strong>Via Phone:</strong> Call +91 98765 43210 (Mon-Sat, 9 AM - 9 PM)
                  </li>
                  <li>
                    <strong>Via WhatsApp:</strong> Message us at +91 98765 43210 with order details
                  </li>
                </ol>
                <div className="bg-yellow-100 border-2 border-yellow-400 p-4 rounded-lg mt-4">
                  <p className="text-sm text-gray-800">
                    <strong>Important:</strong> Please report quality issues within 2 hours of delivery with clear photos for faster processing.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Delivery Failure Refunds</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>Delivery failure due to our fault: 100% refund</li>
                <li>Customer unavailable (after 3 attempts): No refund, 50% rescheduling fee</li>
                <li>Incorrect address: No refund, delivery charges applicable for re-delivery</li>
                <li>Weather/natural calamities: Full refund or free rescheduling</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Due to the perishable nature of our products, we do not offer exchanges. However, if you receive a wrong or damaged product, we will:
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            <section className="bg-gradient-to-r from-pink-600 to-purple-600 text-white p-8 rounded-2xl">
              ...
              <p className="mb-4 text-pink-100">
                Our customer support team is here to help with any refund or cancellation queries:
              </p>
              <div className="space-y-2">
                <p><strong>Email:</strong> refunds@nestsweets.com</p>
                <p><strong>Phone:</strong> +91 98765 43210</p>
                <p><strong>Hours:</strong> Mon-Sat: 9:00 AM - 9:00 PM, Sun: 10:00 AM - 6:00 PM</p>
              </div>
              <div className="mt-6 bg-white/20 backdrop-blur-sm p-4 rounded-xl">
                <p className="text-sm">
                  💡 <strong>Pro Tip:</strong> Enable order notifications to track your order in real-time and avoid delivery issues!
                </p>
              </div>
            </section>
          </div>
