          ...
          <div className="prose prose-pink max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-pink-50 p-6 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600 italic">Examples: Session management, shopping cart, authentication</p>
                </div>
                ...
                <div className="bg-purple-50 p-6 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600 italic">Examples: Language preferences, display settings, saved addresses</p>
                </div>
                ...
                <div className="bg-blue-50 p-6 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600 italic">Examples: Google Analytics, page views, bounce rate, traffic sources</p>
                </div>
                ...
                <div className="bg-green-50 p-6 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600 italic">Examples: Targeted ads, social media integration, remarketing</p>
                </div>
              </div>
            </section>
                ...
                <table className="min-w-full border-collapse border border-gray-300">
                  ...
                  <tbody className="text-gray-700">
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-2">Stores shopping cart data</td>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-2">Saves user settings</td>
            ...
            <section>
              ...
              <div className="bg-gradient-to-r from-pink-100 to-purple-100 p-6 rounded-xl space-y-4">
                <p className="text-gray-700 font-semibold">You can control and manage cookies in several ways:</p>
                
                <div className="space-y-3">
                  <div className="bg-white p-4 rounded-lg">
                    <h3 className="font-bold mb-2">Browser Settings</h3>
                    <p className="text-gray-700 text-sm">
                      Most browsers allow you to refuse or accept cookies. Check your browser&apos;s help menu for instructions.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-lg">
                    ...
                    <p className="text-gray-700 text-sm">
                      Click the &quot;Cookie Settings&quot; button at the bottom of our website to customize your preferences.
                    </p>
                  </div>
                ...
                <div className="bg-yellow-100 border-2 border-yellow-400 p-4 rounded-lg">
                  <p className="text-sm text-gray-800">
                    <strong>⚠️ Note:</strong> Disabling certain cookies may affect website functionality and your user experience.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">How to Delete Cookies</h2>
              <div className="space-y-3">
                <div className="bg-white border-2 border-gray-200 p-4 rounded-lg">
                  <p className="font-semibold mb-2">🌐 Chrome</p>
                  <p className="text-gray-700 text-sm">Settings → Privacy and Security → Clear Browsing Data</p>
                </div>
                <div className="bg-white border-2 border-gray-200 p-4 rounded-lg">
                  <p className="font-semibold mb-2">🦊 Firefox</p>
                  <p className="text-gray-700 text-sm">Options → Privacy & Security → Clear Data</p>
                </div>
                <div className="bg-white border-2 border-gray-200 p-4 rounded-lg">
                ...
                <div className="bg-white border-2 border-gray-200 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700 text-sm">Settings → Privacy & Services → Choose What to Clear</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li><strong>Facebook Pixel:</strong> Social media integration and targeted advertising</li>
                <li><strong>Payment Gateways:</strong> Secure payment processing</li>
                <li><strong>Delivery Partners:</strong> Order tracking and logistics</li>
              </ul>
            </section>
            ...
            <section className="bg-gradient-to-r from-pink-600 to-purple-600 text-white p-8 rounded-2xl">
              ...
              <div className="space-y-2">
                <p><strong>Email:</strong> privacy@nestsweets.com</p>
